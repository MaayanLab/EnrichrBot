...
df = pd.read_csv(PTH+'data/IDG_TargetList_Y3_20190701.csv')
...
df.to_csv(PTH+'data/IDG_TargetList_Y3_20190701.csv',index=False)
  
# create links
harmonizome_link = 'http://amp.pharm.mssm.edu/Harmonizome/gene/' + gene
archs4_link = 'https://amp.pharm.mssm.edu/archs4/gene/' + gene
geneshot_link = "https://amp.pharm.mssm.edu/geneshot/index.html?searchin=" + gene + "&searchnot=&rif=autorif" # TODO: choose library at random (autorif, generif, ...)
...
# Construct the tweet
message = "The @MaayanLab developed several resources to explore and predict knowledge about " + gene
message = '''%s
%s''' % (message, geneshot_link+" "+harmonizome_link+" "+archs4_link+" "+pharos_link)
