...
<ol>
  ...
  <li>
  If the tweet does not contains a gene but a similar name is found, EnrichrBot replies with the closes gene name and askes the users to reply again with the gene name.
  </li>
  <li>
